...
![Version: 1.4.0-bb.1](https://img.shields.io/badge/Version-1.4.0--bb.1-informational?style=flat-square) ![AppVersion: 8.9.0](https://img.shields.io/badge/AppVersion-8.9.0-informational?style=flat-square)
...
| elasticsearch.version | string | `"8.9.0"` | Elasticsearch version |
...
| elasticsearch.image.tag | string | `"8.9.0"` | Elasticsearch image tag |
