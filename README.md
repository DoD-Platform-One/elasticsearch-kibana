...
![Version: 0.12.0-bb.0](https://img.shields.io/badge/Version-0.12.0--bb.0-informational?style=flat-square) ![AppVersion: 8.4.2](https://img.shields.io/badge/AppVersion-8.4.2-informational?style=flat-square)
...
| elasticsearch.version | string | `"8.4.3"` | Elasticsearch version |
...
| elasticsearch.image.tag | string | `"8.4.3"` | Elasticsearch image tag |
