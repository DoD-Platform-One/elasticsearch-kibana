...
![Version: 1.15.0-bb.0](https://img.shields.io/badge/Version-1.15.0--bb.0-informational?style=flat-square) ![AppVersion: 8.13.4](https://img.shields.io/badge/AppVersion-8.13.4-informational?style=flat-square)
...
| elasticsearch.version | string | `"8.13.4"` | Elasticsearch version |
...
| elasticsearch.image.tag | string | `"8.13.4"` | Elasticsearch image tag |
