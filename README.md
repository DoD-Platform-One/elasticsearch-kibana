...
![Version: 1.10.0-bb.4](https://img.shields.io/badge/Version-1.10.0--bb.4-informational?style=flat-square) ![AppVersion: 8.12.1](https://img.shields.io/badge/AppVersion-8.12.1-informational?style=flat-square)
...
| elasticsearch.version | string | `"8.12.1"` | Elasticsearch version |
...
| elasticsearch.image.tag | string | `"8.12.1"` | Elasticsearch image tag |
