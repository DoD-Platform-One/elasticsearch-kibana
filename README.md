...
![Version: 1.23.0-bb.0](https://img.shields.io/badge/Version-1.23.0--bb.0-informational?style=flat-square) ![AppVersion: 8.16.1](https://img.shields.io/badge/AppVersion-8.16.1-informational?style=flat-square) ![Maintenance Track: bb_integrated](https://img.shields.io/badge/Maintenance_Track-bb_integrated-green?style=flat-square)
...
| elasticsearch.version | string | `"8.16.1"` | Elasticsearch version |
...
| elasticsearch.image.tag | string | `"8.16.1"` | Elasticsearch image tag |
...
| metrics.image.tag | string | `"1.8.0"` |  |
