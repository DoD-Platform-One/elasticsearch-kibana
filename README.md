...
![Version: 0.13.0-bb.0](https://img.shields.io/badge/Version-0.13.0--bb.0-informational?style=flat-square) ![AppVersion: 8.5.0](https://img.shields.io/badge/AppVersion-8.5.0-informational?style=flat-square)
...
| elasticsearch.version | string | `"8.5.0"` | Elasticsearch version |
...
| elasticsearch.image.tag | string | `"8.5.0"` | Elasticsearch image tag |
