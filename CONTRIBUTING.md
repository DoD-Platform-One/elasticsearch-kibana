...
3. Write tests using [Cypress](https://www.cypress.io) and [Helm Unittest](https://github.com/helm-unittest/helm-unittest)
...
6. During this time, ensure that all new commits from `main` are rebased into your branch so that it remains up to date.
